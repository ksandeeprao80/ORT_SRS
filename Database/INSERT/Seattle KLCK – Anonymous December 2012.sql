...
BEGIN TRAN
	...
	SELECT 
		'Seattle KLCK – For All December 2012' AS SurveyName, 1 AS CustomerId, 1 AS StarMarked, 1 AS RewardEnabled,
...
---------------------------------------------------------------------------------------------------------------
	...
	INSERT INTO TR_SurveySettings(SurveyId,SettingId,CustomerId,Value) SELECT @SurveyId,SettingId,1,'' FROM MS_SurveySettings WHERE SettingName = 'InvitePassword'	
	...
	INSERT INTO TR_SurveySettings(SurveyId,SettingId,CustomerId,Value) SELECT  @SurveyId,SettingId,1,'3' FROM MS_SurveySettings WHERE SettingName = 'TemplateId'
	...
	VALUES('Question('+CONVERT(VARCHAR(12),@QuestionId11)+').Answer == Answer('+CONVERT(VARCHAR(12),@Ans80)+')',CONVERT(VARCHAR(12),@EndOfBlock),CONVERT(VARCHAR(10),@Welcome),@SurveyId)
 	INSERT INTO dbo.TR_SkipLogic(LogicExpression,TrueAction,FalseAction,SurveyId)-- Montage
