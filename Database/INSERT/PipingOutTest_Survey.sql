...
BEGIN TRAN
	...
	SELECT 
		'PipingAndPipingOutTest' AS SurveyName, 1 AS CustomerId, 1 AS StarMarked, 1 AS RewardEnabled,
...
--------------------------------------------------------------------
	...
	SELECT @Q1, SettingId, 
			CASE WHEN SettingId IN(1,3) THEN 'True'  
				WHEN SettingId IN(2,4,5,6,10,11) THEN 'False'
				WHEN SettingId IN(7) THEN '0'
				WHEN SettingId IN(8,9,12) THEN '' END AS Value 
...
--------------------------------------------------------------------
	...
	SELECT @4, SettingId, 
			CASE WHEN SettingId IN(1,2,3) THEN 'True'  
				WHEN SettingId IN(4,5,6,10,11) THEN 'False'
				WHEN SettingId IN(7) THEN '0'
				WHEN SettingId IN(8,9,12) THEN '' END AS Value 
	FROM MS_QuestionSettings
...
--------------------------------------------------------------------
	...
	INSERT INTO TR_QuestionSettings(QuestionId,SettingId,Value)
	SELECT @Q7, SettingId, 
			CASE WHEN SettingId IN(1,2,3,11) THEN 'True'  
				WHEN SettingId IN(4,5,6,10) THEN 'False'
				WHEN SettingId IN(7) THEN '0'
...
--------------------------------------------------------------------
	...
	SELECT @Q87, SettingId, 
			CASE WHEN SettingId IN(1,2,3,4,6,10,11) THEN 'False'  
				WHEN SettingId IN(5) THEN 'True'
				WHEN SettingId IN(7) THEN '0'
				WHEN SettingId IN(8,12) THEN '' 
...
--------------------------------------------------------------------
	...
	SELECT @Q152, SettingId, 
			CASE WHEN SettingId IN(1,2,3,4,5) THEN 'True'  
				WHEN SettingId IN(6,10,11) THEN 'False'
