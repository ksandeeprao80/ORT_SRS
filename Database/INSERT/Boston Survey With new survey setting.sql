...
BEGIN TRAN
	...
	SELECT 
		'Boston Quota Survey' AS SurveyName, 1 AS CustomerId, 1 AS StarMarked, 1 AS RewardEnabled,
...
--------------------------------------------------------------------
	...
	SELECT @ImageDisplay, SettingId, 
			CASE WHEN SettingId IN(1,3,6) THEN 'True'  
				...
				WHEN SettingId IN(8) THEN '1436' -- ORT 353
				END AS Value  
	FROM MS_QuestionSettings
...
--------------------------------------------------------------------
	...
	INSERT INTO TR_SurveySettings(SurveyId,SettingId,CustomerId,Value) SELECT @SurveyId,SettingId,1,'surveyEngine2.html' FROM MS_SurveySettings WHERE SettingName = 'SurveyTemplateName'
	INSERT INTO TR_SurveySettings(SurveyId,SettingId,CustomerId,Value) SELECT @SurveyId,SettingId,1,'surveyEngine2_ThankYou.html' FROM MS_SurveySettings WHERE SettingName = 'SurveyThankuPage'
	...
	INSERT INTO TR_SurveySettings(SurveyId,SettingId,CustomerId,Value) SELECT @SurveyId,SettingId,1,'SurveyEngine2_Expired.html' FROM MS_SurveySettings WHERE SettingName = 'SurveyExpiredPage'
	INSERT INTO TR_SurveySettings(SurveyId,SettingId,CustomerId,Value) SELECT @SurveyId,SettingId,1,'surveyEngine2_Rewards.html' FROM MS_SurveySettings WHERE SettingName = 'SurveyRewardPage'
	...
	INSERT INTO TR_SurveySettings(SurveyId,SettingId,CustomerId,Value) SELECT @SurveyId,SettingId,1,'surveyEngine2_AccessDenied.html' FROM MS_SurveySettings WHERE SettingName = 'AccessDeniedPage'
	...
	-- Quota Expire
	INSERT INTO TR_SurveySettings(SurveyId,SettingId,CustomerId,Value)SELECT @SurveyId,SettingId,1,'surveyEngine2_QuotaExpire.html' FROM MS_SurveySettings WHERE SettingName = 'QuotaExpirePage' 
	-- Quota Email
