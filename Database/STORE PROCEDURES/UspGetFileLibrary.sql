IF EXISTS 
(
	SELECT * FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID('[dbo].[UspGetFileLibrary]') 
	AND OBJECTPROPERTY(id, N'IsProcedure') = 1
)
DROP PROCEDURE [dbo].[UspGetFileLibrary]

GO

/*
EXEC UspGetFileLibrary 1,3,'<?xml version="1.0" encoding="utf-16"?>
<User>
	<UserId>5</UserId>
...
*/
CREATE PROCEDURE DBO.UspGetFileLibrary
	@CustomerId INT,
	@LibTypeId INT,
