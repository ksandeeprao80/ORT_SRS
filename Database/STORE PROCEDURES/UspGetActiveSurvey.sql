IF EXISTS 
(
	SELECT * FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID('[dbo].[UspGetActiveSurvey]') 
	AND OBJECTPROPERTY(id, N'IsProcedure') = 1
)
DROP PROCEDURE [dbo].[UspGetActiveSurvey]

GO
/*
-- UspGetActiveSurvey 1,'<?xml version="1.0" encoding="utf-16"?>
<User>
  <UserId>5</UserId>
...
*/
CREATE PROCEDURE DBO.UspGetActiveSurvey
	@CustomerId INT,
