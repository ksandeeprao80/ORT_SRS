IF EXISTS 
(
	SELECT * FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID('[dbo].[UspSaveMusicLibrary]') 
	AND OBJECTPROPERTY(id, N'IsProcedure') = 1
)
DROP PROCEDURE [dbo].UspSaveMusicLibrary

GO
/*
EXEC UspSaveMusicLibrary '<?xml version="1.0" encoding="utf-16"?>
<Library>
...
CREATE PROCEDURE DBO.UspSaveMusicLibrary
	@XmlData AS NTEXT,
...
BEGIN TRY
	...
	BEGIN
		...
		BEGIN
			...
			SELECT 
				'General', @LibraryId, 'General', @CreatedBy, GETDATE(), @CreatedBy, GETDATE() 
