IF EXISTS 
(
	SELECT * FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID('[dbo].[UspGetMySurvey]') 
	AND OBJECTPROPERTY(id, N'IsProcedure') = 1
)
DROP PROCEDURE [dbo].[UspGetMySurvey]

GO
/*
-- UspGetMySurvey 39,'<?xml version="1.0" encoding="utf-16"?>
<User>
  <UserId>5</UserId>
...
*/
CREATE PROCEDURE DBO.UspGetMySurvey
	@CustomerId INT,
