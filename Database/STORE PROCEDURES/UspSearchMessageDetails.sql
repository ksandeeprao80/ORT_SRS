IF EXISTS 
(
	SELECT * FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID('[dbo].[UspSearchMessageDetails]') 
	AND OBJECTPROPERTY(id, N'IsProcedure') = 1
)
DROP PROCEDURE [dbo].[UspSearchMessageDetails]

GO
/*
-- EXEC UspSearchMessageDetails 23,6,'<?xml version="1.0" encoding="utf-16"?>
<User>
	<UserId>5</UserId>
 ...
 */
CREATE PROCEDURE DBO.UspSearchMessageDetails
	@MessageLibId INT,
	@CategoryId INT,
...
BEGIN TRY
	...
	BEGIN
		SELECT   
			...
			LTRIM(RTRIM(ISNULL(TML.TemplateName,''))) AS TemplateName,
