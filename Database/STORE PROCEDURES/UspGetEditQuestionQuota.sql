IF EXISTS 
(
	SELECT * FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID('[dbo].[UspGetEditQuestionQuota]') 
	AND OBJECTPROPERTY(id, N'IsProcedure') = 1
)
DROP PROCEDURE [dbo].[UspGetEditQuestionQuota]

GO
-- UspGetEditQuestionQuota 
CREATE PROCEDURE DBO.UspGetEditQuestionQuota
	@QuestionId INT = NULL
AS
SET NOCOUNT ON
