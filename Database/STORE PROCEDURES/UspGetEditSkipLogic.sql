IF EXISTS 
(
	SELECT * FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID('[dbo].[UspGetEditSkipLogic]') 
	AND OBJECTPROPERTY(id, N'IsProcedure') = 1
)
DROP PROCEDURE [dbo].[UspGetEditSkipLogic]

GO

-- EXEC UspGetEditSkipLogic 1304
CREATE PROCEDURE DBO.UspGetEditSkipLogic
	@SurveyId INT 
AS
SET NOCOUNT ON
