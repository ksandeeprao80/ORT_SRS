IF EXISTS 
(
	SELECT * FROM DBO.SYSOBJECTS WHERE ID = OBJECT_ID('[dbo].[UspSearchLibrarySurvey]') 
	AND OBJECTPROPERTY(id, N'IsProcedure') = 1
)
DROP PROCEDURE [dbo].[UspSearchLibrarySurvey]

GO
/*
--EXEC UspSearchLibrarySurvey 18,5,'<?xml version="1.0" encoding="utf-16"?>
<User>
	<UserId>5</UserId>
 ...
 */
CREATE PROCEDURE DBO.UspSearchLibrarySurvey
	@LibId INT,
	@CategoryId INT = NULL,
...
BEGIN TRY
	...
	BEGIN
		SELECT   
			...
			TSL.SurveyLibName, TLC.CategoryId, TLC.CategoryName, TSL.SurveyId, TSL.CreatedBy,
			TSL.CreatedOn, TSL.ModifiedBy, TSL.ModifiedOn 
